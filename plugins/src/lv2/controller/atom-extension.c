...
char* get_new_preset_label(Controller* self, LV2_Atom* atom, unsigned int current_value);


void Atom_instantiate(Controller* self) {
    // FIXME
...
// char* get_new_preset_label(Controller* self, LV2_Atom* atom, unsigned int index_preset) {
//     // const URIs* uris = &self->uris;
